...
public class CannonView extends SurfaceView implements SurfaceHolder.Callback{
    ...
    public CannonView(Context context, AttributeSet attrs){
        ...
        // Configurar atributos de audio para o jogo
        AudioAttributes.Builder attrBuilder = new AudioAttributes.Builder();
        attrBuilder.setUsage(AudioAttributes.USAGE_GAME);

        // Inicializar o SoundPool para reproduzir os tres efeitos do app
        SoundPool.Builder builder = new SoundPool.Builder();
        builder.setMaxStreams(1);
        builder.setAudioAttributes(attrBuilder.build());
        soundPool = builder.build();

        // Cria objeto Map de sons e carrega os sons
    ...
    // Obtem a largura de tela do jogo
    public int getScreenWidth(){
        return screenWidth;
    }

    // Obtem a altura de tela do jogo
